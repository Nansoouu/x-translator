# x-translator - Video Translation & Subtitling

> **Speak to the world. For real.**  
> Paste a YouTube, TikTok or Instagram video and get it subtitled in 20 languages in 2 minutes.  
...
| 🏢 **Brands & Marketing** | One TikTok campaign, 12 markets. Instead of paying 12 agencies, you do it all from a single URL. |
| 📰 **Journalists & Media** | Decode a Korean interview, transcribe an Arabic report, subtitle a Portuguese doc. |
| ✈️ **Travelers & Curious minds** | You find an amazing video in German, a vlog in Vietnamese, a conference in Russian. Nothing stops you. |
...
| Tier | Price | Per day | Video length | Download |
|------|-------|---------|-------------|----------|
| Anonymous | **Free** | 1 video | 2 min max | 30 min |
| Free | **Free** | 3 videos | 2 min max | 1.5h |
| BYOK | **Free** (your key) | Unlimited | Unlimited | Unlimited |
| Premium | Subscription | 90 min/d | 1.5h max | 3h |

> You can bring your own Groq key (BYOK) for unlimited limits. No credit card needed to start.
...
| Feature | Available |
|---------|:---------:|
| Translate a YouTube video into 20 languages | ✅ |
| Download videos from 10 platforms | ✅ |
| Subtitle in the language of your choice | ✅ |
| Edit subtitles (text, timing) | ✅ |
| Add overlays (logo, text, watermark) | ✅ |
| Analyze video highlights | ✅ |
| Export to SRT, VTT, ASS | ✅ |
| Video editing studio | 🚧 |
| AI voice dubbing | 🚧 |
| Live TV (50 channels) | 🚧 |
| Public API for your tools | 📋 |
...
The entire interface : buttons, menus, messages, help : already speaks **your language**. No forgotten strings.
...
[🇫🇷](readmes/README.fr.md) · [🇪🇸](readmes/README.es.md) · [🇩🇪](readmes/README.de.md) · [🇮🇹](readmes/README.it.md) · [🇵🇹](readmes/README.pt.md) · [🇳🇱](readmes/README.nl.md) · [🇵🇱](readmes/README.pl.md) · [🇷🇺](readmes/README.ru.md) · [🇺🇦](readmes/README.uk.md) · [🇸🇦](readmes/README.ar.md) · [🇮🇷](readmes/README.fa.md) · [🇮🇱](readmes/README.he.md) · [🇮🇳](readmes/README.hi.md) · [🇨🇳](readmes/README.zh.md) · [🇯🇵](readmes/README.ja.md) · [🇰🇷](readmes/README.ko.md) · [🇻🇳](readmes/README.vi.md) · [🇮🇩](readmes/README.id.md) · [🇹🇷](readmes/README.tr.md)
